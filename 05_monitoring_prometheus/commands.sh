...
docker build -t nholuongdocker/webappmonitoring:prometheus .
docker run -d -p 5555:80/tcp nholuongdocker/webappmonitoring:prometheus
docker push nholuongdocker/webappmonitoring:prometheus
